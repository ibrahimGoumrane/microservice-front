...
import { deleteUtilisateur } from "@/lib/actions/user";
import {
...
interface DeleteProps {
  ...
  isDeleted?: boolean; // Not used currently
}
      ...
      <AlertDialogContent>
        ...
        <AlertDialogFooter>
          <BaseForm
            ...
            defaultValues={{ idutilisateur: id.toString() }} // Use idutilisateur for consistency with schema
            actionType="delete"
